    ...
    karma: {
      options: {
        ...
        files: [
          ...
          '<%= yeoman.app %>/bower_components/ionic/release/js/bower_componentsionic.js',
          '<%= yeoman.app %>/bower_components/ionic/release/js/ionic-angular.js',
          '<%= yeoman.app %>/bower_components/angular-mocks/angular-mocks.js',
          '<%= yeoman.app %>/bower_components/moment/moment.js',
          '<%= yeoman.app %>/bower_components/angular-momentjs/angular-momentjs.js',
          '<%= yeoman.app %>/bower_components/ngstorage/ngStorage.js',
